...
<div class="card">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="lastname"  class="form-control" id="lastname" placeholder="curp">
    </div>
  </div>
  <div class="form-group">
...
<label class="checkbox-inline">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">NSS*</label>
    <div class="col-md-6">
      <input type="text" name="address" class="form-control"  id="address1" placeholder="NSS">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Estatura*</label>
    <div class="col-md-6">
      <input type="text" name="email" class="form-control" id="email1" placeholder="Estatura">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="phone" class="form-control" id="phone1" placeholder="peso">
    </div>
  </div>
  <div class="form-group">
