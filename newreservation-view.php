...
<option value="">-- SELECCIONE --</option>
  ...
  <center> ____________________________________________________________________________________________________________</center>
    <div class="form-group">
...
<select name="payment_id" class="form-control" required>
  ...
  <?php endforeach; ?>
    ...
    <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Tiene algun Costo?</label>
    <div class="col-lg-10">
